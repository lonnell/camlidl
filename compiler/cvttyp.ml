...
let rec ml_bigarray_kind ty =
  ...
  | Type_int((Int | UInt), Iunboxed) -> "Bigarray.int_elt"
  | Type_int((Int | UInt), Inative) -> "Bigarray.intnative_elt"
  | Type_int((Int | UInt), I32) -> "Bigarray.int32_elt"
  | Type_int((Int | UInt), I64) -> "Bigarray.int64_elt"
